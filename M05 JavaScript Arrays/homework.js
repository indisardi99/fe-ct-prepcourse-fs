...
function devolverPrimerElemento(array) {
   return array[0]; // Retornar el primer elemento del arreglo recibido por parámetro.
   // Tu código:
}
...
function cuentoElementos(array) {
   ...
   // Tu código:
   let result = array.filter((cuentoElem) => cuentoElem > 18)
...
function mesesDelAño(array) {
   ...
   //recorro el arreglo
      ...
      //¡estan los meses enero marzo y noviembre?
